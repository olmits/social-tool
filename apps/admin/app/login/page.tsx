...
export default function LoginPage() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "radial-gradient(rgba(128,128,128,0.2) 1px, transparent 1px)", backgroundSize: "22px 22px" }}
    >
      <div className="w-full max-w-[392px] px-5">
        <div className="mb-6 flex items-center gap-2.5">
          ...
          <span className="text-[19px] font-semibold tracking-tight">Cadence</span>
        </div>
        ...
        >
          ...
          <p className="mb-6 text-[13.5px] text-muted-foreground">Admin access · single user</p>
        ...
        <p className="mt-5 text-center font-mono text-xs text-muted-foreground">cadence · internal publishing tool</p>
      </div>
    </div>
  );
}
